...
For Clef, the consequence is concrete: name the selected reversal and establish its laws for the operations we admit. A general duality structure does not prove that every ordinary program has a unique inverse. Our working NFT, PHG and FPS manuscripts now distinguish the proposed operational interpretation from the graph representation and its preservation through lowering. Their Markdown revisions will receive a separate publication review before generated editions are updated.
