...
- [Don't Assume All Proofs Are Bulletproof]({{< ref "dont-assume" >}}): Why cryptanalytically-grounded primitives like BLAKE3 survive the quantum transition while reductionist proofs (VSH) reduced to the wrong problem fall, the proof-vs-threat-model companion to this entropy case study.
