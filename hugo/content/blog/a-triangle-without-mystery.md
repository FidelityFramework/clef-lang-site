...
The Bermuda Triangle was the great mystery of the 1970s, the kind of story that sold twenty million copies of Charles Berlitz's paperback and gave Leonard Nimoy a full season of *In Search Of...* episodes to walk through in that baritone voice. Of course it was a product of marketing and pre-Internet pop-culture amplification, and by contrast we are here to talk about math and engineering. When "the fog clears" and the right organizing principles are in place, we found that adjacent framing had a way of lining up, and most often it arrived with a casual mention from a friend with adjacent experience. Once two points were joined, the other simply followed. This is that story.

This is a story of recognition and emergence. While most of the writing on this site is "top down" engineering work, sometimes theory comes along *after* to inform the work in surprising ways. We take those opportunities to note the alignment as the engineering has an opportunity to follow a more principled path. 
