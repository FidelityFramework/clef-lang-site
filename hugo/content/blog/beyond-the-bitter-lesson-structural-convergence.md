...
The line draws blank stares, because it presumes understanding of calculus and formal logic in what otherwise passes for light conversational sarcasm. It is not a quip. Follow it forward: if Bayes collapses to modus ponens at the deterministic limit, then learning, the probabilistic interior beneath that limit, had better be a profunctor over the probability monad. The rest of this section is essentially that consequence in unpacked form.
