...
The word "unikernal" can be seen as coming with some unfair baggage. When the topic comes up, the mental image tends toward austerity: one core, one thread, no allocator, a workload squeezed onto limited hardware. Of course the palette available is much more expansive. 
