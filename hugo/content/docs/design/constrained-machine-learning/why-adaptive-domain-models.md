...
description: "The contribution that grounds this section: typed domain models that infer better, on simpler hardware, and relieve the monolithic language model of work it was never suited to carry"
