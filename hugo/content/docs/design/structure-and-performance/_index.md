...
This section is the *why*. It covers the design decisions that determine how efficiently a program can be lowered: why Clef fits MLIR, why laziness is the hard case and how it is bounded, how [coupling and cohesion](/docs/design/structure-and-performance/coupling-and-cohesion/) translate into cache behavior, what flow-loss analysis measures, and what arity and inlining buy at the boundary. The mechanism that carries out the lowering, Baker, the saturation engine, the nanopass pipeline, the dialect lowerings, lives in [Compiler Internals](/docs/internals/).
